...
<head>
    ...
    <!--begin::Page cutom css (used by this page)-->
    @yield('css')
    <!--end::Page cutom css (used by this page)-->
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-menu flex-column-fluid">
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a href="/dashboard" class="menu-link @if ($menu == 'Dashboard') active @endif">
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8">Administrator</span>
                                </div>
                            </div>

                            @can('admin')
                                <div class="menu-item">
                                    <a href="/penyelenggara" class="menu-link @if ($menu == 'Penyelenggara') 'active' @endif">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <i class="fas fa-user-tag"></i>
                                            </span>
                                        </span>
                                        <span class="menu-title">Penyelenggara</span>
                                    </a>
                                </div>

                                <div class="menu-item">
                                    <a href="/pendaftar" class="menu-link @if ($menu == 'pendaftar') 'active' @endif">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <a href="/layanan" class="menu-link @if ($menu == 'layanan') 'active' @endif">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <a href="/persyaratan" class="menu-link @if ($menu == 'persyaratan') 'active' @endif">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" id="btn-logout" onclick="logout()">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="authentication/email/password-reset.html" target="blank">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Password Reset</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="authentication/email/password-change.html" target="blank">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-0">
                                    <span class="menu-section text-muted text-uppercase fs-8">Layout</span>
                                </div>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="documentation/getting-started.html">
                                    ...
                                    <span class="menu-title">Documentation v8.0.0</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                            ...
                                            <div
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="layouts/aside/without-aside.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-stretch flex-shrink-0">
                                                        ...
                                                        <div class="scroll-y mh-200px mh-lg-325px">
                                                                ...
                                                                <div class="symbol symbol-40px me-4">
                                                                    <span class="symbol-label bg-light">
                                                                        <img class="w-20px h-20px"
                                                                            src="/assets/media/svg/misc/volicity-9.svg"
                                                                            alt="" />
                                                                    </span>
                                                                </div>
                                                                <!--end::Symbol-->
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <div class="symbol symbol-40px me-4">
                                                                    <span class="symbol-label bg-light">
                                                                        <img class="w-20px h-20px"
                                                                            src="/assets/media/svg/misc/tvit.svg"
                                                                            alt="" />
                                                                    </span>
                                                                </div>
                                                                <!--end::Symbol-->
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <div class="symbol symbol-40px me-4">
                                                                    <span class="symbol-label bg-light">
                                                                        <img class="w-20px h-20px"
                                                                            src="/assets/media/svg/misc/leaf.svg"
                                                                            alt="" />
                                                                    </span>
                                                                </div>
                                                                <!--end::Symbol-->
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <div class="symbol symbol-40px me-4">
                                                                    <span class="symbol-label bg-light">
                                                                        <img class="w-20px h-20px"
                                                                            src="/assets/media/svg/misc/tower.svg"
                                                                            alt="" />
                                                                    </span>
                                                                </div>
                                                                <!--end::Symbol-->
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                                        <!--begin::drawer toggle-->
                                        <div class="btn btn-icon btn-active-light-primary w-40px h-40px"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show active" id="kt_topbar_notifications_2"
                                                    ...
                                                    <div class="d-flex flex-column px-9">
                                                        ...
                                                        <!--end::Section-->
                                                        <!--begin::Illustration-->
                                                        <img class="mh-200px" alt="metronic"
                                                            src="/assets/media/svg/illustrations/work.svg" />
                                                        <!--end::Illustration-->
                                                    </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3"
                                        ...
                                        <div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click"
                                            ...
                                            data-kt-menu-flip="bottom">
                                            <img src="/assets/media/avatars/150-2.jpg" alt="icon"
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-item px-5">
                                                <a href="/layanan" class="menu-link px-5">
                                    ...
                                    <div class="d-flex align-items-center d-lg-none ms-2 me-n3"
                                        data-bs-toggle="tooltip" title="Show header menu">
                                        <div class="btn btn-icon btn-active-light-primary"
                            ...
                            <div class="d-flex align-items-center py-1">
                                ...
                                <div data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover"
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary fw-bolder" data-bs-toggle="modal"
                                        ...
                                        id="kt_toolbar_create_button">Create</a>
                                </div>
                            </div>
                        </div>
                    </div>
